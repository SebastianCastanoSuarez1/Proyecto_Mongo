		...
		contentPane.add(lblTipo);
		 ...
		 comboBoxEnfermedad.addActionListener(new ActionListener() {
		 	public void actionPerformed(ActionEvent e) {
				 ...
				 switch(enfermedad) {
				 case "Mental":
					 comboBoxTipo.setModel(new DefaultComboBoxModel<String>(new String[] { "Depresion", "Ansiedad", "Tourette","Estres postraumatico","Trastorno obsesivo-compulsivo","Ictus"}));
					 break;
				case "Hormonal":
					 comboBoxTipo.setModel(new DefaultComboBoxModel<String>(new String[] { "Diabetes", "Hipertiroidismo", "Hipotiroidismo","Síndrome del ovario poliquístico","Enfermedad de Addison","Enfermedad de Graves"}));
					 break;
				 case "Respiratoria":
					 comboBoxTipo.setModel(new DefaultComboBoxModel<String>(new String[] { "Tuberculosis", "Asma", "Asbestosis","Bronquiolitis","Bronquitis","Enfisema","Empiema"}));
					 break;
				 case "Cancer":
					 comboBoxTipo.setModel(new DefaultComboBoxModel<String>(new String[] { "Pulmon", "Piel","Prostata","Higado","Pancreas","Mama","Celebral","Oseo"}));
					 break;
				 case "Dermatologica":
					 comboBoxTipo.setModel(new DefaultComboBoxModel<String>(new String[] { "Dermatitis atopica", "Psoriasis", "Acne","Onicomicosis","Vitíligo","Queratosis actínica"}));
					 break;
				 case "Digestiva":
					 comboBoxTipo.setModel(new DefaultComboBoxModel<String>(new String[] { "Dispepsia", "Enfermedad por reflujo gastroesofágico", "Enfermedad celiaca","Síndrome del intestino irritable","Colitis ulcerosa","Gastritis","Ulceras"}));
					 break;
				 case "Oftalmologica":
					 comboBoxTipo.setModel(new DefaultComboBoxModel<String>(new String[] { "Ambliopía", "Astigmatismo", "Cataratas","Daltonismo","Retinopatía diabética","Síndrome del ojo seco","Miodesopsias"}));
					 break;
